# Inventory — Meridian Residences (current)

> Owned by `inventory-manager`. Source of truth for marketing-permitted-to-reference status.
> Sales-ops / CRM remains source of truth for legal status (sold / reserved / SPA-signed).
...
3. "Only N left" / scarcity claims require RERA pre-approval and dated evidence; check before re-stating.
