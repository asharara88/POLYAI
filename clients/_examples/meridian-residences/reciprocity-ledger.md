# Reciprocity ledger — Meridian Residences
...
- entry_id: rcp-2026-001
  date: 2026-01-12
  counterparty_id: rf-uae-01
  counterparty_name: "[Ruling Family — Emirate A] (anonymized)"
  channel: vvip
  direction: outbound
  type: acknowledgment
...
- entry_id: rcp-2026-002
  date: 2026-01-22
  counterparty_id: si-swf-01
  counterparty_name: "[GCC SWF] (anonymized)"
  channel: vvip
  direction: inbound
  type: event-invited
  description: "Invited developer principal to their annual investment forum (Doha)"
  value_implied: high
  status: complete
  recorded_by: vvip-channel-enablement
...
- entry_id: rcp-2026-003
  ...
  counterparty_name: "Multi-family office (London-DIFC)"
  channel: wealth
  direction: inbound
  type: introduction
...
- entry_id: rcp-2026-005
  date: 2026-03-04
  counterparty_id: pb-jpm-dxb
  counterparty_name: "J.P. Morgan Private Bank — Dubai"
  channel: wealth
  direction: outbound
  type: courtesy
  description: "Initial relationship-building lunch with bank's wealth-management lead"
  value_implied: medium
  status: complete
  recorded_by: wealth-channel-enablement
...
- entry_id: rcp-2026-007
  ...
  direction: outbound
  type: event-invited
  description: "Invited CEO + selected officers to private preview of Q3 launch"
  value_implied: high
...
- entry_id: rcp-2026-010
  ...
  direction: outbound
  type: acknowledgment
  description: "Saudi National Day-adjacent congratulatory note + project-milestone update"
  value_implied: low
  status: complete
  recorded_by: vvip-channel-enablement
```
...
|---|---|---|---|---|
| Multi-family office (London-DIFC) | 2 | 0 | -2 | Approaching threshold; one event-attendance or substantive courtesy owed within 60 days |
...
| GCC SWF | 1 | 1 | 0 | Reciprocated cleanly via private-preview invitation |
| Ruling Family — Emirate A | 1 | 1 | 0 | Balanced |
| J.P. Morgan Private Bank | 0 | 1 | +1 | Healthy outbound posture; reciprocity expectation low (institutional relationship) |
