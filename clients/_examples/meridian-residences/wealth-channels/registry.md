# Wealth-channel registry — Meridian Residences

> Owned by `wealth-channel-enablement`. Source of truth for the wealth side of the channel mix.
> Names below are illustrative for the worked example — replace with real relationships when onboarding a real client.
>
> Confidential: this file references named principals. Do not share outside the marketing + commercial leadership team.
...
|---|---|---|---|---|
| Private banks | 0 | 0 | 6 | 6 (target by launch) |
| Family offices | 0 | 0 | 12 | 12 (target by launch) |
| Independent introducers | 0 | 0 | 18 | 18 (target by launch) |
...
```yaml
- name: "<single-family office, GCC principal>"
  type: single-family
  status: target-new
  primary_principal: # TODO
  geography: GCC
  prior_introductions: 0
  notes: "Approach via mutual relationship; no cold outreach."

- name: "<multi-family office, London-DIFC dual office>"
  type: multi-family
  status: target-new
  primary_principal: # TODO
  geography: [GB, AE]
...
# 9 more target-new family offices to be added during channel-development phase
```
...
# 15 more target-new introducers to be added during channel-development phase
```

## Channel-development priorities (current quarter)

- **Reactivation queue:** (none — engagement just started)
- **New-signing queue:** All 36 entries above are target-new
