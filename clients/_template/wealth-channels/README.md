...
Owned by `wealth-channel-enablement`. Files:
- `registry.md` — relationship registry, segmented by type (private banks, family offices, introducers)
- `materials/` — confidential investor packs and exit-scenario models, watermarked + version-tracked
