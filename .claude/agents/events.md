...
6. **Partner / sponsor coordination** — when an event has external sponsors (hospitality partner, named architect's firm, financial-services partner, automotive partner for valet, etc.), coordinate logo / mention / hosting expectations + deliverables.
